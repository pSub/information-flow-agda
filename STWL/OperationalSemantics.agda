...
thm-BExp-det (opₚ σ b₁ b₂ z t p₁ q₁) (opₚ .σ .b₁ .b₂ z' t' p₂ q₂)
  with thm-BExp-det p₁ p₂ | thm-BExp-det q₁ q₂
thm-BExp-det (opₚ σ b₁ b₂ z t _ _) (opₚ .σ .b₁ .b₂ .z .t _ _) | refl | refl = refl
thm-BExp-det (opᵣ σ a₁ a₂ z₁ z₂ p₁ q₁) (opᵣ .σ .a₁ .a₂ z₃ z₄ p₂ q₂)
  with thm-AExp-det p₁ p₂ | thm-AExp-det q₁ q₂
thm-BExp-det (opᵣ σ a₁ a₂ z z' _ _) (opᵣ .σ .a₁ .a₂ .z .z' _  _) | refl | refl = refl
